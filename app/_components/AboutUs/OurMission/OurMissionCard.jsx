...
const OurMissionCard = ({ desc, img }) => {
  return (
    <div className="relative flex gap-6 h-[254px] md:h-[285px] lg:h-[411px] w-[339px] md:w-[452px] lg:w-[570px]">
      ...
      <div className="w-[146px] h-[191px] md:w-[194] md:h-[254px] lg:w-[254px] lg:h-[379px] rounded-[100%] overflow-hidden flex-shrink-0">
        <Image
      ...
      <Image
        className="absolute left-[30px]  bottom-0 w-[246px] h-[83px] md:w-[328] md:h-[110] lg:w-[382] lg:h-[135]"
